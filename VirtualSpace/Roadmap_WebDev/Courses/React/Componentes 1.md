...
Notese que las etiquetas <h1> y <p> estan estan envueltos en la etiqueta <div>, esto nos indica que  todos los elementos deben estar anidados sobre un solo elemento en este caso un DIV, pero puede ser cualquier otro elemento que sea de apertura y cierre. En react el  podemos cambiar la 